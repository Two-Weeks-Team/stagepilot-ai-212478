...
> AI‑driven cockpit that turns any live event into a flawless production, from script to check‑in to post‑show insights.

---

## Overview

Event producers juggle timelines, speaker cues, sponsor moments, attendee check‑ins, and on‑the‑fly incidents using disjointed tools, leading to errors and wasted time.
...
services:
  - name: api
    github:
      repo: Two-Weeks-Team/stagepilot-ai
      branch: master
